/**
 * 【lp4（福岡版）専用】LPからのフォーム送信を受け取り、写真をGoogle Driveに保存し
 * GmailとLINEグループに通知する
 *
 * ■ デプロイ手順
 ...
 *    - LINE_GROUP_ID             : 通知先LINEグループのID（福岡用の新グループ）
 ...
 *    発行されたURLを lp4/index.html の gasUrl（2箇所）に設定して build.py を実行する
 *
 * ■ LINEグループIDの自動取得
