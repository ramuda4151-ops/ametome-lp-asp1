...
"""
lp2/build.py
マスターHTML（lp2/index.html）をベースに、各ASPディレクトリのindex.htmlを生成するスクリプト。
...
マスター（lp2/index.html）を修正したら、このスクリプトを実行して
...
def main():
    ...
    print("  git add lp2/ && git commit -m 'build: lp2 ASP別HTMLを再生成' && git push origin master")
